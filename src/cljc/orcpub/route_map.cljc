...
(def vtt-rooms-route :vtt-rooms)
(def vtt-room-route :vtt-room)
(def vtt-room-commands-route :vtt-room-commands)
(def vtt-room-stream-route :vtt-room-stream)
(def vtt-assets-upload-route :vtt-assets-upload)
(def vtt-assets-from-url-route :vtt-assets-from-url)
(def vtt-asset-content-route :vtt-asset-content)
(def vtt-rooms-page-route :vtt-rooms-page)
(def vtt-room-page-route :vtt-room-page)
...
(def routes ["/" {"" default-route
                  ...
                  "vtt/" {"rooms" {"" vtt-rooms-route
                                   ["/" :id] {"" vtt-room-route
                                              "/commands" vtt-room-commands-route
                                              "/stream" vtt-room-stream-route}}
                          "assets" {"upload" vtt-assets-upload-route
                                    "from-url" vtt-assets-from-url-route
                                    ["/" :id "/content"] vtt-asset-content-route}}
                  ...
                  "pages/" {"my-account" my-account-page-route
                            ...
                            {"5e/"
                             {"character-builder" dnd-e5-char-builder-route
                              ...
                              "vtt" {"" vtt-rooms-page-route
                                     ["/" :id] vtt-room-page-route}
